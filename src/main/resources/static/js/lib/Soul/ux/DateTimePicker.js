Ext.define("Soul.locale.en.ux.picker.DateTimePicker", {
	  override: "Soul.ux.DateTimePicker",
	  todayText: "现在",
	  timeLabel: '时间'
  });

Ext.define('Soul.ux.DateTimePicker', {
	  extend: 'Ext.picker.Date',
	  alias: 'widget.datetimepicker',
	  todayText: '现在',
	  timeLabel: '时间',
	  width : 200,
	  requires: ['Soul.ux.form.TimePickerField'],
	  ...
	  onRender: function(container, position) {
		  if(!this.timefield) {
			  this.timefield = Ext.create('Soul.ux.form.TimePickerField', {
