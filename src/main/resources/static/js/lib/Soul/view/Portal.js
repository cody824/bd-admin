Ext.define('Soul.view.Portal', {
    ...
    initComponent: function () {
        var lsMainType = localStorage.getItem('portalMainType');
        if (lsMainType) {
            this.mainType = lsMainType;
        }
    ...
    initSingleWin: function (remoteIp) {
         ...
         *
        **/
        Soul.Ajax.executeRequestData(ACTION_URL.GLOBAL_CONFIG_URL, {
            remoteIp: remoteIp,
            requestType: 'macConfig'
        }, function (data) {
            macConfig = data;
            if (macConfig != null) {
