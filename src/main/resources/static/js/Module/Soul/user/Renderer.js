Ext.define('Module.Soul.user.Renderer', {
	singleton: true,
	requires  : [
 		'Soul.util.RendererUtil',
 		'Soul.util.GridRendererUtil',
 		'Module.Soul.user.Tools',
	...
	translateStaffIcon : function(v, u,r, rowIndex, columnIndex, s,view){
		var render = Module.Soul.user.Renderer;
	...
	getUserName : function(val, u,r, rowIndex, columnIndex, s) {
		if (val != null && val.length > 0) {
			...
			return icon + '<a style="cursor:pointer;text-decoration:underline;font-style:italic;" onclick="Module.Soul.user.Tools.showUserInEast(\''+ r.data.name  +'\',event);">' + val + '</a>';
		} else
			return val;
	},
	...
	constructor : function() {
        ...
        this.UM = Module.Soul.user.model.UserModel;
   	}
});