Ext.define('Module.CMS.parameter.Tools', {
	singleton: true, 
	...
	getParameterGrid : function(paramConfig, nameConfig, keySet) {
		...
		var paramGrid = Ext.create('Module.CMS.parameter.view.ParameterGrid',{
			id : 'advGrid',
       		anchor : '100% 100%',
       		store : paramStore
		});
	...
	getParameterPropertyGrid : function(paramConfig){
		...
		var property = Soul.util.ObjectView.getObjectPropertyGrid(paramConfig, Module.CMS.parameter.Config.getRendererConfig(), 
